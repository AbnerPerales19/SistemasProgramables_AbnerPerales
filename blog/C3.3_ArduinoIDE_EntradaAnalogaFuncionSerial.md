...
3. Explique el resultado observado.
   > Primero, en el seput, asignamos la comunicación al puerto serial de 9600 bits por segundo. Luego, ya en el ciclo, asignamos el valor del pin analógico A0 a la variable **sensorValue**, la cual convertimos a voltaje con una fórmula. Luego imprimimos este valor del voltaje por el puerto serial. <br> <br> Lo que sucede es lo siguiente: Mientras el arduino esté pasando corriente a la fotoresitencia, esta fluirá a través de ella y la resistencia, hasta llegar al puerto analógico A0, luego este se lee y se guarda en la variable **sensorValue** y ese valor es transformado a voltaje para poder imprimirse. La cantidad de voltaje que llega a la entrada A0 dependerá de la luz que reciba la fotoresistencia, ya que entré más luz, más voltaje deja pasar.

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.    

<p align="center">
    <img alt="SalidaDigital" src="../img/C3.3_Evidencia1.png" width=600 height=450>
</p>
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.3_Evidencia2.png" width=600 height=450>
</p>
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.3_Evidencia3.png" width=600 height=450>
</p>
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.3_Evidencia4.png" width=600 height=450>
</p>
...
:page_with_curl: [Ver en repositorio](https://github.com/AbnerPerales19/SistemasProgramables_AbnerPerales/blob/master/blog/C3.3_ArduinoIDE_EntradaAnalogaFuncionSerial.md)