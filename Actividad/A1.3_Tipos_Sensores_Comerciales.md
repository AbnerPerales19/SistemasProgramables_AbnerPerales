...
3. Una vez que conoce el tema a desarrollar, investigue y redacte dentro de este documento los puntos siguiente:
   ...
   - **Desarrollo**
    ...
    #### :page_facing_up: [Enlace directo a la presentacion.](https://github.com/AbnerPerales19/SistemasProgramables_AbnerPerales/blob/master/pdfs/A1.3_Presentacion.pdf) :page_facing_up:
